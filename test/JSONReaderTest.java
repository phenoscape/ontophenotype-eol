...
public class JSONReaderTest {
	...
	/**
	 * Tests the JSON Reader on a basic test case, using a taxon with 3
	 * annotations
	 */
	@Test
	public void testJSONReaderBasic() {
		...
		AnnotationCollection annotationCollection = jsonReader
				.readFile("test\\resources\\Taxon Annotations part.json");
	...
	/**
	 * Tests the JSON Reader on a JSON file containing all taxon phenotype
	 * annotations
	 */
	@Test
	public void testJSONReaderFullTaxon() {
		...
		AnnotationCollection annotationCollection = jsonReader
				.readFile("test\\resources\\Taxon Annotations.json");
